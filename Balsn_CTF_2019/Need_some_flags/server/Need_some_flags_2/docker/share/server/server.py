...
def editflag():
  ...
  if edited:
    ...
    exit()
  edited=True
  print "Why do you want to edit the flag? You should be more careful! I can only let you edit 2 bytes and only edit once"
  ...
  flagfile=open(filename,"w")
  editcontent=raw_input("Please input the edited content (in hex)").decode("hex")[:2]
